 ...
 */
import { createGovernanceExpressApp } from './governance-server.js';
import { validateBuildConfig, determineRequiredApprovals } from './governance.js';
...
function testExpressAppCreation() {
    ...
    try {
        ...
        const apiDocsRoute = routes.find((r) => r.path === '/' && r.method === 'GET');
...
//# sourceMappingURL=test-governance-api.js.map