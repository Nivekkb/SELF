 ...
 */
function loadLexicon(): SelfConfig["lexicon"] {
...
export const selfConfig: SelfConfig = {
  thresholds: {
    s1: 1,
    s2: 3,
    s3: 6,
 ...
 */
export function reloadLexicon(): void {
 ...
 */
export function getLexicon(): Readonly<SelfConfig["lexicon"]> {
